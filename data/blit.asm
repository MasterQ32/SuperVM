...
__internal__label0:
	...
	get 2  ; local y
	sub [f:yes] [r:discard]
	[ex(z)=0] [ex(n)=0] push 1
	[ex(z)=0] [ex(n)=1] push 0
	[ex(z)=1] push 0
	[i0:peek] nop [f:yes]
	drop [f:no]
...
__internal__label2:
	...
	; c := read(source [Addition] conv(int32(3) [Multiplication] y [Multiplication] w [Addition] x [Addition] int32(0)))
	push 0 
	get 1  ; local x
	get -5  ; argument w
	get 2  ; local y
	...
	; c := c [Addition] int32(0x100) [Multiplication] read(source [Addition] conv(int32(3) [Multiplication] y [Multiplication] w [Addition] x [Addition] int32(0)))
	push 0 
	get 1  ; local x
	get -5  ; argument w
	get 2  ; local y
	...
	; c := c [Addition] int32(0x10000) [Multiplication] read(source [Addition] conv(int32(3) [Multiplication] y [Multiplication] w [Addition] x [Addition] int32(0)))
	push 0 
	get 1  ; local x
	get -5  ; argument w
	get 2  ; local y
