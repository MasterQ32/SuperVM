...
cd D:\felix\projects\SuperVM\libvm\
...
cl %INIT% svmln.c getopt.c %OPTIONS%
...
SET DEVICES=devices\timer.c
cl %INIT% /I "vs\SDL-1.2.15\include" emulator.c vm.c getopt.c %DEVICES% %OPTIONS% /link %LIBS%
